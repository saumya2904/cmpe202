public class Burger extends LeafDecorator
{
    ...
    public void setOptions( String[] options )
    {
        ...
        {
            if ( "1/3lb".equals(options[i]) ) this.price += 7.00 ;
            ...
            if ( "Organic Bison*".equals(options[i]) ) this.price += 10.00 ;
            if ( "Hormone & Antibiotic Free Beef".equals(options[i]) ) this.price += 4.00 ;
